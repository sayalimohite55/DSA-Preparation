...
*
* Example: Input: num = 3749    Output: "MMMDCCXLIX"
* Explanation:
...
public class IntegerToRoman {
    ...
    public static void main(String[] args) {
        System.out.println("Result: "+convertIntegerToRoman(3749));
        System.out.println("Result: "+convertIntegerToRoman(58));
        System.out.println("Result: "+convertIntegerToRoman(1994));
    }
}
