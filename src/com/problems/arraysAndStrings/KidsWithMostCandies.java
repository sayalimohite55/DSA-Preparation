...
public class KidsWithMostCandies {
    ...
    public static void main(String[] args) {
        System.out.println("Result: "+String.valueOf(kidsWithCandies(new int[]{2,3,5,1,3},3)));
        System.out.println("Result: "+String.valueOf(kidsWithCandies(new int[]{4,2,1,1,2},1)));
        System.out.println("Result: "+String.valueOf(kidsWithCandies(new int[]{12,1,12},10)));
    }
}
